...
define dso_local i32 @main() #0 !dbg !25 {
  ...
  %x.dfsan.label = load i8, ptr %5, align 1, !dbg !50
  call void @__implicit_branch_callback(i8 %45, i8 %x.dfsan.label, i32 23, i32 19, ptr @1), !dbg !50
  %y.dfsan.label = load i8, ptr %7, align 1, !dbg !50
  call void @__implicit_branch_callback(i8 %45, i8 %y.dfsan.label, i32 23, i32 19, ptr @2), !dbg !50
  %z.dfsan.label = load i8, ptr %9, align 1, !dbg !50
  call void @__implicit_branch_callback(i8 %45, i8 %z.dfsan.label, i32 23, i32 19, ptr @3), !dbg !50
...
50:                                               ; preds = %48, %0
  ...
  %y.dfsan.label1 = load i8, ptr %7, align 1, !dbg !58
  call void @__implicit_branch_callback(i8 %55, i8 %y.dfsan.label1, i32 27, i32 15, ptr @4), !dbg !58
  %z.dfsan.label2 = load i8, ptr %9, align 1, !dbg !58
  call void @__implicit_branch_callback(i8 %55, i8 %z.dfsan.label2, i32 27, i32 15, ptr @5), !dbg !58
...
60:                                               ; preds = %58, %50
  ...
  %z.dfsan.label3 = load i8, ptr %9, align 1, !dbg !64
  call void @__implicit_branch_callback(i8 %61, i8 %z.dfsan.label3, i32 31, i32 11, ptr @6), !dbg !64
